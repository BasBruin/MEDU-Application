...
{
    public partial class Hamburger_Instellingen : Form
    {
        public Hamburger_Instellingen()
        {
            InitializeComponent();
        }
        ...
        private void Inloggen_Paint(object sender, PaintEventArgs e)
        {
            Inloggen.BackColor = Color.FromArgb(16, 92, 124);
        }
        ...
        private void Kruisje_Ham_Click(object sender, EventArgs e)
        {
            this.Hide();
            Instellingen f5 = new Instellingen();
            f5.ShowDialog();
